...
export const bookingsAPI = {
  create: async (bookingData: { listing: string; start_date: string; end_date: string; notes?: string; hotel_room?: string; stripe_payment_intent_id?: string }): Promise<Booking> => {
