<header id="header" class="main-header fixed-header">
                            ...
                            <div class="inner-header">
                                <div class="inner-header-left">
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="../index.html"><img src="../assets/images/logo/logo@2x.png" alt="logo" width="166" height="48"></a></div>
                                    </div>
                                            ...
                                            <nav class="main-menu show navbar-expand-md">
                                                <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                    <ul class="navigation clearfix">
                                                        <li class="home current"><a href="../index.html">Home</a>
                                                        </li>
                                                        ...
                                                        <li><a href="./property-details.html">Properties</a>
                                                        </li>
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo"><a href="./index.html"><img src="../assets/images/logo/logo@2x.png" alt="nav-logo" width="174" height="44"></a></div>
                        <div class="bottom-canvas">
                            <div class="login-box flex align-center">
                                <a href="signin.html" data-bs-toggle="modal">Login</a>
                                <span>/</span>
                                <a href="./signup.php" data-bs-toggle="modal">Register</a>
                            </div>
