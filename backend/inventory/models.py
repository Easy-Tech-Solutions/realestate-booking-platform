...
class ListingFlag(models.Model):
    ...
    ai_score = models.FloatField(null=True, blank=True, help_text='Populated asynchronously by the local scoring model — see aiscoring.tasks.score_listing_flag_task.')
